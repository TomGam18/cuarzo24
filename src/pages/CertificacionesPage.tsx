...
const CertificacionesPage = () => {
  ...
  const buttonConfig = [
    { label: 'CERTIFICACIONES ISO', sectionId: 'certificaciones-iso' },
    { label: 'RSE', sectionId: 'rse' },
    { label: 'CÓDIGO DE ÉTICA', sectionId: 'codigo-etica' },
  ];
  ...
  return (
    <main className="bg-white py-4">
        ...
        <div className="relative z-10 flex w-full flex-col gap-12 md:flex-row md:items-start">
          <div className="z-10 w-full max-w-2xl space-y-6 text-left md:w-3/5 md:pr-20 lg:pr-28">
            <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
              ...
              certificación ISO el 23 de diciembre de 2024. En el marco de
              nuestro décimo aniversario, este logro refleja nuestro compromiso
            ...
            <div className="flex w-full max-w-sm flex-col gap-3">
              {buttonConfig.map(({ label, sectionId }) => (
                <button
                  key={label}
                  type="button"
      ...
      <section
        ...
        className="relative left-1/2 z-20 mt-12 w-screen -translate-x-1/2 bg-brand-nav py-16 text-white"
      >
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-12 px-6 text-center md:px-12 lg:px-24">
          ...
          <div className="flex w-full flex-row items-center justify-center gap-4 text-white md:gap-10 lg:gap-16">
            {[
              ...
              <div
                key={imageSrc}
                className="flex max-w-sm flex-1 justify-center"
              >
                <img
                  src={imageSrc}
      ...
      <div className="-mx-6 -mt-12">
        ...
        <section
          id="rse"
          className="relative left-1/2 w-screen -translate-x-1/2 mt-6 py-6 md:mt-12 md:py-12"
        >
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 md:gap-10 md:px-12 lg:px-16">
            <div className="flex flex-col items-center gap-4 md:gap-6 lg:flex-row lg:items-start lg:gap-8">
              ...
              <div className="flex w-full flex-col gap-1.5 text-brand-footer lg:w-1/2">
                ...
                <p className="text-sm leading-snug text-brand-nav md:text-base md:leading-relaxed md:text-gray-700">
                  ...
                  forma de contribuir al desarrollo sustentable de Argentina y
                  la región".
                </p>
                <p className="text-sm leading-snug text-brand-nav md:text-base md:leading-relaxed md:text-gray-700">
                  ...
                  una política explícita, en la que se definen valores y
                  acciones basados en el respeto hacia:
                </p>
                <p className="text-sm leading-snug text-brand-nav md:text-base md:leading-relaxed md:text-gray-700">
      ...
      <section
        id="codigo-etica"
        className="relative left-1/2 w-screen -translate-x-1/2 py-6 md:py-12"
      >
          ...
          <div className="flex w-full flex-col gap-6 text-brand-nav md:text-gray-700">
            <div className="space-y-3">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                ...
                principios de ética y desarrollo sostenible en el desempeño de
                las funciones de CUARZO 24 SA. La ética en la empresa requiere
                que los accionistas, directivos y administradores, se
                constituyan como garantes del presente código de ética.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                CUARZO 24 SA mantiene relaciones estables con nuestros clientes
                y proveedores, basadas en la creación de valor, confianza,
                afrontando con responsabilidad los compromisos adquiridos.
                Contribuimos al desarrollo social y económico, innovando e
                implementando nuevas tecnologías que propicien mejoras sociales
                y medioambientales.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                CUARZO 24 SA trabaja para la creación de oportunidades de
                empleo. Abogando el trato con dignidad, respeto y justicia hacia
                los empleados, teniendo en consideración su diferente
                sensibilidad cultural, evitando cualquier tipo de discriminación
                respetando la diversidad, facilitando todo tipo de comunicación
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                Las prácticas de CUARZO 24 SA tienen en cuenta la preservación
                del medio ambiente, según lo establecido en la PMP (Política
                Medioambiental propia).
              </p>
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                Todos los empleados, en el ámbito de sus funciones, deben
                conocer y asumir dicha política y actuar en todo momento de
                acuerdo con los criterios de respeto y sustentabilidad. También
                adoptar hábitos y conductas relacionadas con las buenas
                prácticas medioambientales contribuyendo al logro de los
                objetivos establecidos, esforzándose en minimizar el impacto
                medioambiental derivado de sus actividades y de la utilización
                de las instalaciones, equipos y medios de trabajo puestos a su
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                CUARZO 24 SA de acuerdo con la legislación vigente, garantizará
                la confidencialidad de los datos de sus clientes,
                comprometiéndose a no revelar los mismos a terceros, salvo
                consentimiento del cliente o por obligación legal, o
                cumplimiento de resoluciones judiciales o administrativas.
              </p>
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                Asimismo, garantiza el derecho de modificación y rectificación
                de datos a terceros, siempre y cuando ésta sea necesaria. No
                obstante, los empleados guardarán la confidencialidad de los
                datos antes referidos, en el desempeño de su actividad
                profesional, y se abstendrán de cualquier utilización
                inapropiada.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-base leading-snug text-brand-nav md:text-lg md:leading-relaxed md:text-gray-700">
                Mantener el principio de neutralidad política, como muestra
                además de respeto a las diferentes opiniones y sensibilidades de
